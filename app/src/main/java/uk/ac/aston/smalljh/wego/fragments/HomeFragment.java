...
public class HomeFragment extends Fragment {
    ...
    private class ContactArrayAdaptor extends ArrayAdapter<HomeItem> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView title= (TextView) rowView.findViewById(R.id.home_description);
            TextView time= (TextView) rowView.findViewById(R.id.home_time);
            ImageView flag = (ImageView) rowView.findViewById(R.id.home_icon);
